...
<div class="topframe">
	...
	<div id="toolDiv" class="xtool minitool">
		<div><i>&#xf1001;</i><b class="show"><%=auth.getName() %> (<%=auth.getAccount() %>)</b></div>
...
<div id="titleDIV" class="minititle">业务管理系统</div>
</div>
...
<div region="center" data-options="border:false" style="overflow:hidden;">
	<div id="tt" class="easyui-tabs" data-options="fit:true,plain:false,tools:'#tab-tools'" style="overflow:hidden;">
		<div title="首页" style="overflow:hidden;" closable="false">
			<div style="overflow:hidden;width:100%;height:100%;"><iframe id="rightFrame" name="rightFrame" scrolling="no" frameborder="0" src="about:blank;"></iframe></div>
		</div>
	</div>
	<div id="tab-tools">
